var issueContinerEl = document.querySelector("#issues-container");
...
var displayIssues = function(issues) {
    if (issues.length === 0) {
        issueContinerEl.textContent = "This repo has no open issues!";
        return;
    }
    for (var i = 0; i < issues.length; i++) {
        ...
        issueContinerEl.appendChild(issueEl);
    }
};
